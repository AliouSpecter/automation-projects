# tools/post_notion_brief.ps1
# Cree une page Notion avec le Weekly Brief Google Ads Test Engine
# Contenu dans .tmp/notion_brief_blocks.json (UTF-8)
#
# Usage:
#   powershell.exe -ExecutionPolicy Bypass -File tools/post_notion_brief.ps1
...
$blocksFile = Join-Path $PSScriptRoot "..\.tmp\notion_brief_blocks.json"
$blocksJson = [System.IO.File]::ReadAllText($blocksFile, [System.Text.Encoding]::UTF8).Trim()

# ── Build full payload (all ASCII except blocks content) ─────────────────────
$title = "Google Ads Test Engine - Weekly Brief - Semaine du 2026-03-09"
